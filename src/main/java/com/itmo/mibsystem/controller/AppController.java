...
public class AppController {
    ...
    @GetMapping({"/", "/index"})
    public ModelAndView openSpecificIndexPage(Model model) throws Exception {
        Role.Type buff = getRole();
        return new ModelAndView("redirect:/" + getPathPrefix(buff) + "Index", model.asMap());
    }
